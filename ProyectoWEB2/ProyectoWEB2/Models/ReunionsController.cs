...
namespace ProyectoWEB2.Models
{
    public class ReunionsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "id,diayhora,usuarios,Virtual,clientes,ClienteNombre")] Reunion reunion)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "id,diayhora,usuarios,Virtual,clientes,ClienteNombre")] Reunion reunion)
        {
            if (ModelState.IsValid)
            {
